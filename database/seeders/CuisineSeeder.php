            ...
            [
                ...
                'cuisines' => [
                    ...
                    [
                        'name' => 'Nepalese',
                        'slug' => 'nepalese',
                        'description' => 'Himalayan cuisine built around dal bhat, steamed momos, and Newari specialties, with warming spices and lentils.',
                        'icon' => '🥟',
                        'sort_order' => 13,
                    ],
                    [
                        'name' => 'Tibetan',
                        'slug' => 'tibetan',
                        'description' => 'High-altitude comfort food featuring thenthuk noodle soup, tsampa roasted barley, and savory meat pies.',
                        'icon' => '🍲',
                        'sort_order' => 14,
                    ],
                    [
                        'name' => 'Burmese',
                        'slug' => 'burmese',
                        'description' => "Myanmar's distinctive salads, mohinga fish noodle soup, and coconut-chicken khao swe noodles.",
                        'icon' => '🍜',
                        'sort_order' => 15,
                    ],
                ],
            ...
            [
                ...
                'cuisines' => [
                    ...
                    [
                        'name' => 'Russian',
                        'slug' => 'russian',
                        'description' => 'Hearty Eastern European fare featuring borscht, pelmeni dumplings, blini, and beef stroganoff.',
                        'icon' => '🥞',
                        'sort_order' => 11,
                    ],
                ],
            ...
            [
                ...
                'cuisines' => [
                    ...
                    [
                        'name' => 'Afghan',
                        'slug' => 'afghan',
                        'description' => 'Central Asian cuisine featuring Kabuli palaw, mantu dumplings, bolani flatbread, and charcoal-grilled kebabs.',
                        'icon' => '🍛',
                        'sort_order' => 7,
                    ],
                ],
