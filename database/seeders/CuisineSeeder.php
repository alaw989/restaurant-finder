            ...
            [
                ...
                'cuisines' => [
                    ...
                    [
                        'name' => 'Taiwanese',
                        'slug' => 'taiwanese',
                        'description' => 'Night market street food culture and comfort dishes including beef noodle soup, bao, and bubble tea.',
                        'icon' => '🧋',
                        'sort_order' => 10,
                    ],
                    [
                        'name' => 'Cambodian',
                        'slug' => 'cambodian',
                        'description' => 'Delicate flavors built around prahok, kroeung spice pastes, and fresh herbs, featuring amok and kuy teav.',
                        'icon' => '🍲',
                        'sort_order' => 11,
                    ],
                    [
                        'name' => 'Lao',
                        'slug' => 'lao',
                        'description' => 'Sticky rice-based cuisine with herbaceous salads, grilled meats, and papaya salad with a distinct pungent flavor profile.',
                        'icon' => '🌿',
                        'sort_order' => 12,
                    ],
                ],
